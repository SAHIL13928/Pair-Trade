...
const Header = () => {
  return (
    <div className="flex items-center justify-center bg-gray-100 p-4 shadow">
      <div className="relative mr-auto w-full max-w-3xl">  
        <input 
          type="text" 
          className="w-full p-4 pl-24 rounded-full border border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-600 bg-white text-black"
          placeholder="Search..." 
        />
